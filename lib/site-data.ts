...
export const defaultSiteConfig: SiteConfig = {
  ...
  description: "Somos una empresa líder en el sector de la construcción, con más de 20 años de experiencia. Nos especializamos en obras residenciales, comerciales y reformas integrales.",
...
export const defaultServices: Service[] = [
  {
    ...
    description: "Construcción de viviendas unifamiliares y edificios residenciales con los más altos estándares de calidad.",
    icon: "home"
  },
  {
    id: "2",
    title: "Obras Comerciales",
    description: "Desarrollo de espacios comerciales, oficinas y locales adaptados a las necesidades de tu negocio.",
    icon: "building"
  },
  {
    id: "3",
    title: "Reformas Integrales",
    description: "Renovación completa de espacios existentes, modernizando y optimizando cada rincón.",
    icon: "hammer"
  },
  {
    id: "4",
    title: "Proyectos Industriales",
    description: "Construcción de naves industriales, almacenes y centros logísticos de alta eficiencia.",
    icon: "factory"
  }
];
